...
def bench_render_horned(
    ...
    *,
    ...
    """Render an ontology file using the Rust horned-bench binary.

    Args:
        path:    Path to the ontology file.
        fmt:     horned-bench --format value (omn, ofn, owx, rdf).
                 Note: fastobo-omn does not support render mode.
